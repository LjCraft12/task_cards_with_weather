...
var WeatherService = (function () {
    ...
    WeatherService.prototype.getCurrentLocation = function () {
        if (navigator.geolocation) {
            ...
            return Observable_1.Observable.throw("Geolocation not avaliable");
        }
    };
    WeatherService.prototype.getCurrentWeather = function (lat, long) {
        var url = constats_1.FORECAST_ROOT + constats_1.FORECAST_KEY + "/" + lat + "," + long;
    ...
    WeatherService.prototype.getLocationName = function (lat, long) {
        var url = constats_1.GOOGLE_ROOT;
        var queryParams = "?latlng=" + lat + "," + long + "&key=" + constats_1.GOOGLE_KEY;
